...
class SeekerMyWorkitRecentlyViewedSearchScreen extends StatefulWidget {
  const SeekerMyWorkitRecentlyViewedSearchScreen({super.key});

  @override
  State<SeekerMyWorkitRecentlyViewedSearchScreen> createState() => _SeekerMyWorkitRecentlyViewedSearchScreenState();
}

class _SeekerMyWorkitRecentlyViewedSearchScreenState extends State<SeekerMyWorkitRecentlyViewedSearchScreen> {
  // 최근 검색 기록 리스트 (기존 기능 유지)
  List<String> recentSearches = ["Recentlyviewed", "name", "name", "name"];
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            decoration: const InputDecoration(
                              // [수정] 힌트 텍스트 변경
                              hintText: "Search in recently viewed", 
                              hintStyle: TextStyle(
